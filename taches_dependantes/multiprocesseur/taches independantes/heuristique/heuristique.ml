...
let oc =open_out "/home/falou/ExactAlgoritmNew/heuristique/debugHeuristique.ml"  in
let load = ref 0.0 in 
for i=0 to m-1 do
...
while (!i< (List.length t) & ((!schedulable)=true)) do 
     ...
     let b_ot= ref {istart_time=0;itrans=0;perm=0;schedule=Array.create (1) 0 ;schedulable=false} in
...
(*Main *)
let main=
let nomficResult="/home/falou/ExactAlgoritmNew/results/resultHeuristique.ml" in
let nomficResultSucces="/home/falou/ExactAlgoritmNew/results/resultHeuristqueSuccess.ml" in
