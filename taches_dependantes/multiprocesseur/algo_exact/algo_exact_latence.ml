...
let fic_result_success="/home/ROCQ/aoste/fndoye/simulations/result/multi_pro/latence/latence_algo_exact_nbproc_fixed_3_10_tasks_bis.ml" in
...
(*lres:=(insert_result {ab=((!moy_load/.(float_of_int !numT)) );ord=((float_of_int !numbsuccess)/.(float_of_int !numT))} !lres);*)
  (* if(!numbsuccess!=0) then 
 lres:=(insert_result {ab=(float_of_int nbproc );ord=(!latence)} !lres);*)
