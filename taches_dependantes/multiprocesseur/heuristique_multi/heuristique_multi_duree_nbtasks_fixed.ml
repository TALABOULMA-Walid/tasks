...
let nomfichier="/home/ROCQ/aoste/fndoye/simulations/tasks/nbtasks_varie2/" in
let fic_result_success="/home/ROCQ/aoste/fndoye/simulations/result/multi_pro/duree/nbtasks_fixed/duree_heur_multi_with_100_tasks_3_15_bis_procs.ml" in
...
for k=10 to  10 do
 ...
 lres:=(insert_result {ab=(float_of_int nbproc);ord=(!duree_heuristique)} !lres);
