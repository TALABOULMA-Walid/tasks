...
(***************************************************************************************)
let new_schedulability_condition ltask =
...
let t_2={id=2;firstActivation=0;wcet=2;period=1180;deadline=180;preemption_cost=0;wrtTask=128} in
...
let t_1={id=1;firstActivation=2;wcet=1;period=150;deadline=150;preemption_cost=0;priority=(1.0 /. (float_of_int 6));ci_t= (Array.create (150) 0);di_t=(Array.create (150) 0)} in
let t_2={id=2;firstActivation=0;wcet=2;period=1180;deadline=180;preemption_cost=0;priority=(1.0 /. (float_of_int 4));ci_t= (Array.create (1180) 0);di_t=(Array.create (1180) 0)} in
let t_3={id=3;firstActivation=2;wcet=2;period=130;deadline=130;preemption_cost=1;priority=(1.0 /. (float_of_int 12));ci_t= (Array.create (131) 0);di_t=(Array.create (131) 0)} in
let t_4={id=4;firstActivation=2;wcet=1;period=250;deadline=250;preemption_cost=0;priority=(1.0 /. (float_of_int 6));ci_t= (Array.create (250) 0);di_t=(Array.create (250) 0)} in
let t_5={id=5;firstActivation=0;wcet=2;period=128;deadline=128;preemption_cost=0;priority=(1.0 /. (float_of_int 4));ci_t= (Array.create (128) 0);di_t=(Array.create (128) 0)} in
let t_6={id=6;firstActivation=2;wcet=2;period=130;deadline=130;preemption_cost=1;priority=(1.0 /. (float_of_int 12));ci_t= (Array.create (131) 0);di_t=(Array.create (131) 0)} in
(*let t_7={id=7;firstActivation=2;wcet=1;period=50;deadline=50;preemption_cost=0;priority=(1.0 /. (float_of_int 6));ci_t= (Array.create (50) 0);di_t=(Array.create (50) 0)} in
let t_8={id=8;firstActivation=0;wcet=2;period=128;deadline=128;preemption_cost=0;priority=(1.0 /. (float_of_int 4));ci_t= (Array.create (128) 0);di_t=(Array.create (128) 0)} in
let t_9={id=9;firstActivation=2;wcet=2;period=130;deadline=130;preemption_cost=1;priority=(1.0 /. (float_of_int 12));ci_t= (Array.create (130) 0);di_t=(Array.create (130) 0)} in
let t_10={id=10;firstActivation=2;wcet=1;period=50;deadline=50;preemption_cost=0;priority=(1.0 /. (float_of_int 6));ci_t= (Array.create (50) 0);di_t=(Array.create (50) 0)} in
let t_11={id=11;firstActivation=0;wcet=2;period=128;deadline=128;preemption_cost=0;priority=(1.0 /. (float_of_int 4));ci_t= (Array.create (128) 0);di_t=(Array.create (128) 0)} in
let t_12={id=12;firstActivation=2;wcet=2;period=130;deadline=130;preemption_cost=1;priority=(1.0 /. (float_of_int 12));ci_t= (Array.create (130) 0);di_t=(Array.create (130) 0)} in*)
...
new_schedulability_condition ltask;
