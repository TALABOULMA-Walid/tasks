...
let t_1=ref {id=1;firstActivation=0;wcet=1;period=6;deadline=6;preemption_cost=0;priority=(1.0/. 6.0);ci_t= 0;di_t=0;bi_t=0;lpred=[];lsucc=[];indice=0;priority_t=(1.0/. 6.0);lbuffer=[];set_blocked_tasks=[];idpro=1;ltime_data_succ=[|{idTask=3;t_read_data=12}|]} in
let t_2=ref {id=2;firstActivation=0;wcet=1;period=24;deadline=24;preemption_cost=0;priority=(1.0 /. 6.0);ci_t= 0;di_t=0;bi_t=0;lpred=[];lsucc=[];indice=0;priority_t=(1.0/. 6.0);lbuffer=[];set_blocked_tasks=[];idpro=2;ltime_data_succ=[|{idTask=3;t_read_data=12};{idTask=5;t_read_data=21}|]} in
let t_3=ref {id=3;firstActivation=0;wcet=1;period=12;deadline=12;preemption_cost=0;priority=(1.0 /. 12.0);ci_t=0;di_t=0;bi_t=0;lpred=[];lsucc=[];indice=1;priority_t=(1.0/. 12.0);lbuffer=[];set_blocked_tasks=[];idpro=1;ltime_data_succ=[|{idTask=4;t_read_data=24};{idTask=5;t_read_data=21}|]} in
let t_4=ref {id=4;firstActivation=0;wcet=2;period=24;deadline=24;preemption_cost=0;priority=(1.0 /. 24.0);ci_t=0;di_t=0;bi_t=0;lpred=[];lsucc=[];indice=2;priority_t=(1.0/. 24.0);lbuffer=[];set_blocked_tasks=[];idpro=2;ltime_data_succ=[||]} in
let t_5=ref {id=5;firstActivation=10;wcet=1;period=6;deadline=6;preemption_cost=0;priority=(1.0 /. 12.);ci_t=0;di_t=0;bi_t=0;lpred=[];lsucc=[];indice=1;priority_t=(1.0/. 12.0 );lbuffer=[];set_blocked_tasks=[];idpro=2;ltime_data_succ=[||]} in

t_1:={id=1;firstActivation=0;wcet=1;period=6;deadline=6;preemption_cost=0;priority=(1.0 /. (float_of_int 6));ci_t= 0;di_t=0;bi_t=0;lpred=[];lsucc=[!t_3];indice=0;priority_t=(1.0/.(float_of_int 6));lbuffer=[{idBuf=1;priority_buf=(priority_buffer [!t_1;!t_3]);setTasks_may_use_b=[!t_1;!t_3]}];set_blocked_tasks=[];idpro=1;ltime_data_succ=[|{idTask=3;t_read_data=12}|]};
...
t_4:={id=4;firstActivation=0;wcet=2;period=24;deadline=24;preemption_cost=1;priority=(1.0 /. (float_of_int 24));ci_t= 0;di_t=0;bi_t=0;lpred=[!t_3];lsucc=[];indice=2;priority_t=(1.0/.(float_of_int 24));lbuffer=[{idBuf=3;priority_buf=(priority_buffer [!t_3;!t_4;!t_5]);setTasks_may_use_b=[!t_3;!t_4;!t_5]};{idBuf=4;priority_buf=(priority_buffer [!t_4]);setTasks_may_use_b=[!t_4]}];set_blocked_tasks=[];idpro=2;ltime_data_succ=[||]} ;  

t_5:={id=5;firstActivation=10;wcet=2;period=6;deadline=6;preemption_cost=1;priority=(1.0 /. (float_of_int 12));ci_t= 0;di_t=0;bi_t=0;lpred=[!t_2;!t_3];lsucc=[];indice=1;priority_t=(1.0/.(float_of_int 12));lbuffer=[{idBuf=3;priority_buf=(priority_buffer [!t_3;!t_4;!t_5]);setTasks_may_use_b=[!t_3;!t_4;!t_5]};{idBuf=5;priority_buf=(priority_buffer [!t_5]);setTasks_may_use_b=[!t_5]}];set_blocked_tasks=[];idpro=2;ltime_data_succ=[||]};
...
(*****************************************************************************************************************************)
(*
(*************** Condition d'ordonnançabilité basée sur quantité de travail  déterminée par W(t)=t ****************)
ordonnançabilite_heuristique ltask ti = *)
