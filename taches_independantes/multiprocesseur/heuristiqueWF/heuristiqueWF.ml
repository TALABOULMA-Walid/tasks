...
let oc =open_out "/home/ROCQ/aosteroc/fndoye/ExactAlgoritmNew/heuristique/debugHeuristiqueWF.ml"  in
let load = ref 0.0 in 
for i=0 to 0 do
...
(*Main *)
let main=
let nomficResult="/home/ROCQ/aosteroc/fndoye/ExactAlgoritmNew/results/resultHeuristiqueWFCPUTime.ml" in
let nomficResultWF="/home/ROCQ/aosteroc/fndoye/ExactAlgoritmNew/results/resultHeuristiqueWFLoad.ml" in
let nomficResultSucces="/home/ROCQ/aosteroc/fndoye/ExactAlgoritmNew/results/resultHeuristiqueWFSucessRatio.ml" in
let suc =open_out  nomficResultSucces in
let load =open_out  nomficResultWF in
